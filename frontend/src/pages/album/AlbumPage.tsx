                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex p-6 gap-6 pb-8">
                            ...
                            <div className="flex flex-col justify-end">
                                ...
                                <div className="flex items-center gap-2 text-small text-zinc-100">
                        ...
                        <div className="px-6 pb-4 flex items-center gap-6">
                            <Button
                                ...
                                size='icon'
                                className="size-14 rounded-full bg-rose-400 hover:bg-rose-400 hover:scale-105 transition-all"
                            >
                        ...
                        {/**Table/Content of the album with songs */}
